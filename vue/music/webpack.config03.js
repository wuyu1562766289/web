...
module.exports = {
    ...
    entry: {
        ...
        'main': './code/webpack_test/03_html/main.js'
    },
    output: {
        path: path.resolve(path.resolve('./code/webpack_test/03_html/dist')),
        filename: 'build.js'
    },
                ...
                use: [
                    {
                        ...
                        options: {
                            ...
                            publicPath: path.resolve('./code/webpack_test/03_html/dist/img'),  // 打包的公共路径
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            template: './code/webpack_test/03_html/index.html', // 参照物
        })
    ]
}